...
STREAM_LAYERS = [256, 256, 256]      # X stream and Y stream are identical size
STREAM_OUT    = 256             # output embedding size per stream

# Merger network (takes concatenated X+Y embeddings)
MERGER_LAYERS = [256, 256, 256]      # fuses the two 128-dim streams
