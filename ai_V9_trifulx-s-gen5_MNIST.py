...
STREAM_LAYERS = [64, 64, 64]      # X stream and Y stream are identical size
STREAM_OUT    = 32             # output embedding size per stream

# Merger network (takes concatenated X+Y embeddings)
MERGER_LAYERS = [64, 64, 64]      # fuses the two 128-dim streams
